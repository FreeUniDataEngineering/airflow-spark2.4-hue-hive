...
# **Airflow:**
  ...
  თქვენთვის ყველაზე მეტად საჭირო დირექტორიები იქნება dags, jobs და data. აქ ჩაყრით თქვენს დაგებსა და საჭირო ფაილებს. ამ სამ ფოლდერში ფაილების განაწილების მაგალითები ნახეთ examples-ში.
